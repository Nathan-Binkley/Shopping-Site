...
products[0] = new Product("123FP", "Frank Pierce", 1.99);
products[1] = new Product("135GR", "Ghost Rider", 99.99);
products[2] = new Product("246JM", "Jacob Marley", 19.99);
products[3] = new Product("234BSB", "The Soul of the Brave Sorcerer Balthazar", 30.00);
products[4] = new Product("345CP", "Cameron Poe", 4.99);
products[5] = new Product("567FF", "Fred Flintstone", 49.99);
products[6] = new Product("678AO", "Alley Oop", 59.99);
products[7] = new Product("789AH", "Atilla The Hun", 29.99);
products[8] = new Product("891CC", "Captain Caveman", 29.99);
products[9] = new Product("912GC", "Grug Crood", 45.99);
products[10] = new Product("123SJE", "Sargent Joe Enders", 29.99);
products[11] = new Product("456CC", "Chick Clusters", 19.99);
products[12] = new Product("789MM", "Major Millitz", 5.99);
products[13] = new Product("123YO", "Yuri Orlov", 19.99);
products[14] = new Product("456WG", "Will Gerard", 4.99);
...
// shipping
var shipping_rate =0;           // will not be applied if free_shipping = true
var free_shipping_allowed = false;   // ship free if spending quota is met
var free_shipping_quota = 40;     // applied if free_shipping_allowed, set to 0.00 for always free
...
function cartToTable()
{
    ...
    if (num_items>0)
    {
        html_cart_str = "<p class='SPACE'> Please review your order. Press 'Update' to change quantities. " +
                        "To remove an item from your card, change the quantity to zero. " +
                        "Press 'Checkout' when you are ready to place your order.</p>";
        ...
        for (i=0; i<products.length; i++)
        {
            ...
            total = sub_total + tax;
            shipping_rate = Math.round(total * .2);
